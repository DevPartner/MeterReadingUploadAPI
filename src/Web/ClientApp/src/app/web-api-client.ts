...
export interface IMeterReadingItemsClient {
...
export class MeterReadingItemsClient implements IMeterReadingItemsClient {
    ...
    createMeterReadingItems(file: FileParameter | null | undefined): Observable<UploadResult> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateMeterReadingItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateMeterReadingItems(response_ as any);
                } catch (e) {
    ...
    protected processCreateMeterReadingItems(response: HttpResponseBase): Observable<UploadResult> {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["errors"])) {
                ...
                for (let item of _data["errors"])
                    this.errors!.push(UploadError.fromJS(item));
            }
        }
    }
...
export class UploadError implements IUploadError {
    ...
    static fromJS(data: any): UploadError {
        data = typeof data === 'object' ? data : {};
        let result = new UploadError();
        result.init(data);
        return result;
    }
