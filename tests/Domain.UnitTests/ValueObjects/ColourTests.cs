using MeterReadingUploadAPI.Domain.Exceptions;
using MeterReadingUploadAPI.Domain.ValueObjects;
using NUnit.Framework;
using Shouldly;

namespace MeterReadingUploadAPI.Domain.UnitTests.ValueObjects;
